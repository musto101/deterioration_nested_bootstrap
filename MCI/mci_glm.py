...
grid = {'elasticnet__alpha': np.arange(0.01, 1, 0.01), 'elasticnet__l1_ratio': np.arange(0.01, 5, 0.01)}
...
pipe = Pipeline([('imputer', knnImp), ('ros', ros), ('scaler', scaler), ('rs', rs), ('elasticnet', elasticnet)])
...
metrics.to_csv('data/mci_glm.csv')

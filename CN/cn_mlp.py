...
grid = {'mlp__hidden_layer_sizes': [(10,), (50, ), (100, ), (10, 10), (50, 50), (100, 100), (10, 10, 10), (50, 50, 50),
        ...
        'mlp__max_iter': [10000], 'mlp__alpha': [0.0001, 0.001, 0.01, 0.1, 0.5],
...
knnImp = KNNImputer(n_neighbors=5, add_indicator=False)
scale = StandardScaler()
rs = resample(replace=True, n_samples=500)
ros = RandomOverSampler()
# X_res, y_res = ros.fit_resample(X, y)
mlp = MLPClassifier(early_stopping=True, tol=0.01, n_iter_no_change=10, validation_fraction=0.1)

pipe = Pipeline([('imputer', knnImp), ('scale', scale), ('ros', ros), ('rs', rs), ('mlp', mlp)])
...
mcMetrics.to_csv('data/cn_mlp_metrics.csv')
